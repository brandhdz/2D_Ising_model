...
set ylabel "χ_m" font "Helvetica, 16"
...
#Standard_error
#pl '../data/START=cold,ALGORITHM=Metropolis,L=100/Mean_values/magnetization_standard.dat' u 1:4:5 w yerrorbars t 'L = 100', '../data/START=cold,ALGORITHM=Metropolis,L=80/Mean_values/magnetization_standard.dat' u 1:4:5 w yerrorbars t 'L = 80', '../data/START=cold,ALGORITHM=Metropolis,L=50/Mean_values/magnetization_standard.dat' u 1:4:5 w yerrorbars t 'L = 50', '../data/START=cold,ALGORITHM=Metropolis,L=30/Mean_values/magnetization_standard.dat' u 1:4:5 w yerrorbars t 'L = 30', '../data/START=cold,ALGORITHM=Metropolis,L=10/Mean_values/magnetization_standard.dat' u 1:4:5 w yerrorbars t 'L = 10'
